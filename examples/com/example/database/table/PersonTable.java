...
public final class PersonTable {
    ...
    public static final String SQL_CREATE = "CREATE TABLE `person` (_id INTEGER PRIMARY KEY AUTOINCREMENT, `name` TEXT DEFAULT NULL, `age` INTEGER NOT NULL, `alive` INTEGER DEFAULT 1, `body_fat` NUMERIC, `id_place` LONG, FOREIGN KEY(id_place) REFERENCES place(_id) ON UPDATE NO ACTION ON DELETE CASCADE, UNIQUE( `name`, `id_place` ))";
